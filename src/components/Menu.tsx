...
import type { HomeData, MenuItemData, SiteData, SpeisekarteData } from "@/lib/content";

/** The € sign belongs to the design — the admin stores bare numbers. */
function priceLabel(item: MenuItemData): string {
  ...
  return (
    ...
    >
      ...
      <div className="mt-12 border-t border-border lg:mt-16">
        {speisekarte.sections.map((category, ci) => {
